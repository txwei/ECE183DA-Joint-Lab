...
robot = supervisor.getFromDef('paperbot')
...
o0 = np.zeros((10*1000,1))
o1 = np.zeros((10*1000,1))
o2 = np.zeros((10*1000,1))
o3 = np.zeros((10*1000,1))
o4 = np.zeros((10*1000,1))
o5 = np.zeros((10*1000,1))
o6 = np.zeros((10*1000,1))
o7 = np.zeros((10*1000,1))
o8 = np.zeros((10*1000,1))

# get control signals from the control algorithm
# for j in range(3):
trajectory_num = 23 # change this number to test out new trajectories
...
while supervisor.step(timestep) != -1:
	...
	motor_L.setVelocity(v_l)
	motor_R.setVelocity(v_r)
	...
	trans = robot.getPosition()
	position_data[i] = [trans[2],-trans[0]]
	rotat = robot.getOrientation()
	orientation_data[i] = rotat[6]
...
#output = np.hstack((o0,o1,o2,o3,o4,o5,o6,o7,o8))
